...
public class TextController : MonoBehaviour {
	...
	void cell (){
		...
		text.text = 	"You are in a room. You don't remember how you got here, \n" +
				"the only thing you know is that you're in a prison, sitting on the ground. Both your\n" +
				"hands and feet are chained.You can see some sheets on the floor \n" + 
				"and pieces of broken glass all over the place.Something is written on the wall. \n" +
				"There is blood right in front of you and a locked security door beside you. \n" +
				"Suddenly, you hear screams coming from the other side of the security door. \n" +
	...
	void letter(){
		...
		text.text =	" ''You might not remember, but I am your wife. \n" +
